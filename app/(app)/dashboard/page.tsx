...
import { contarPedidosPendentes, listarPedidosRecentes, caixaFechadoHoje } from '@/lib/actions/pedidos'
...
export default async function DashboardPage() {
  ...
  return (
    <div className="px-6 py-5">
      ...
      <div className={podeVerFinanceiro ? 'grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4' : 'grid grid-cols-1 gap-4 sm:max-w-xs'}>
        {kpis.map((k, i) => (
          <div
            key={k.label}
            className="u-stagger u-motion rounded-xl border border-border bg-surface p-5 shadow-[0_10px_30px_-18px_rgba(0,0,0,0.6)] hover:border-brand/40 hover:-translate-y-0.5 hover:shadow-[0_18px_40px_-18px_rgba(0,0,0,0.35)] active:translate-y-0"
